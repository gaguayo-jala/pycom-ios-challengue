...
typedef NS_ENUM(NSInteger, FKFlickrBlogsGetServicesError) {
	...
	FKFlickrBlogsGetServicesError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
