...
typedef NS_ENUM(NSInteger, FKFlickrGalleriesGetInfoError) {
	...
	FKFlickrGalleriesGetInfoError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
