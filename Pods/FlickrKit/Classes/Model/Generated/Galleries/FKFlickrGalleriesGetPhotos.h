...
typedef NS_ENUM(NSInteger, FKFlickrGalleriesGetPhotosError) {
	...
	FKFlickrGalleriesGetPhotosError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
