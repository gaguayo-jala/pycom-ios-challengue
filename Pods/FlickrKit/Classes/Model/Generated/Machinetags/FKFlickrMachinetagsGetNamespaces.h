...
typedef NS_ENUM(NSInteger, FKFlickrMachinetagsGetNamespacesError) {
	...
	FKFlickrMachinetagsGetNamespacesError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
