...
typedef NS_ENUM(NSInteger, FKFlickrAuthGetFullTokenError) {
	...
	FKFlickrAuthGetFullTokenError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
...
@property (nonatomic, copy) NSString *mini_token; /* (Required) */
