...
typedef NS_ENUM(NSInteger, FKFlickrGroupsDiscussRepliesGetListError) {
	...
	FKFlickrGroupsDiscussRepliesGetListError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
...
@property (nonatomic, copy) NSString *per_page; /* (Required) */
