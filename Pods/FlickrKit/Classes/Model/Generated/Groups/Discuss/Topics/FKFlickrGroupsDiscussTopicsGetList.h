...
typedef NS_ENUM(NSInteger, FKFlickrGroupsDiscussTopicsGetListError) {
	...
	FKFlickrGroupsDiscussTopicsGetListError_WriteOperationFailed = 106,		 /* The requested operation failed due to a temporary issue. */
